...
Con `TLS_FORCE_HTTPS=true`, las peticiones HTTP con un host que no figura en `ACME_DOMAINS` se
redirigen a la primera entrada de la lista que no sea wildcard.
