---
title: Плагины
description: "Как расширить панель плагинами: модель безопасности WASM-песочницы, официальный каталог и разделы про установку, разработку и публикацию."
layout: default
lang: ru
category: Плагины
order: 340
...
![Шестнадцатеричный редактор файлов игрового сервера — пример плагина GameAP](/images/ru/plugins/hex-editor.png)
