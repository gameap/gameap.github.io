...
GameAP полностью поддерживает Counter-Strike 2, включая управление игроками.
...
и вставьте его в поле "Server Token (sv_setsteamaccount)".
Это обычное текстовое поле, отмеченное как **Только для администраторов**, — оно отображается только администраторам.
...
На этой же вкладке находятся поле "Server hostname" и выпадающий список "Default Map"
с 17 картами (по умолчанию `de_dust2`); при необходимости можно ввести название своей карты.
