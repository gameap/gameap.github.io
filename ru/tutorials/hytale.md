...
Для начала вам необходимо [установить GameAP](/ru/get_started.html#установка-панели), это займёт несколько минут:
...
использовать предложенный; порт Hytale по умолчанию — 5520.
* Порты query и RCON заполняются автоматически, вводить их не нужно.
...
![Файл с зашифрованными данными авторизации Hytale](/images/ru/tutorials/hytale/auth_enc_file.png)

### Настройки игрового сервера

#### Настройки в панели

На вкладке **Настройки** игрового сервера есть одно поле, относящееся к Hytale: "Memory. Max heap size (Xmx)" — 
максимальный размер кучи Java, по умолчанию 4G.
