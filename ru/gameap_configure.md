...
какое-либо сокращение.

#### Версия движка

Числовая или строковое значение версии движка.
...
Поддерживаются следующие архивы: Zip, 7z, Tar, XZ, Bzip, GZip. RAR архивы не поддерживаются
